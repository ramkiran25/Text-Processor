 ...
 *
 * Uses a real {@link StreamingTextParser} and real output strategies —
 * the focus is correctness of the full pipeline, not mock interactions.
 *
 * The package matches {@code com.textprocessor.service} so that
 * {@code runTwoPasses} (package-private) is accessible without reflection.
 */
class TextProcessingServiceTest {
    ...
    void output_isFlushedOnCompletion() throws IOException {
        ...
        service.runTwoPasses(
                () -> new StringReader("Flush test sentence."),
                writer,
